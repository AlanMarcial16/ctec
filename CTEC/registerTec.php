                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4"><b>Nuevo Técnico!</b></h1>
                            </div>
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="dropdown col-sm-6 mb-4">
                                        ...
                                        <div class="dropdown-menu animated--fade-in"
                                            ...
                                            <a class="dropdown-item" href="#">Dispositivos moviles</a>
                                            <a class="dropdown-item" href="#">Televisiones</a>
                                            <a class="dropdown-item" href="#">Tv & Av</a>
                                        </div>
                                    </div>
                                </div>
